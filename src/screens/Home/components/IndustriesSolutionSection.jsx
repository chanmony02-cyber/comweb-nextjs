...
import { getIndustrySolutions } from "@/services/industries";

export default function IndustriesSolutionSection() {
  const industrySolutions = getIndustrySolutions();
      ...
      <div className="container">
        ...
        <div className="flex flex-col gap-16 md:gap-24">
          {industrySolutions.map((item) => (
            ...
            >
              {/* Image */}
              <div className="relative w-full h-[560px] md:w-1/2 rounded-xl overflow-hidden shadow-lg">
                <Image
                  src={item.image}
                  alt={item.title}
                  fill
