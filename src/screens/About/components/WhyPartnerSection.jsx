      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] gap-10 lg:gap-16 items-center">
          ...
          <div className="relative pb-10 lg:pb-14">
            <div className="relative h-80 overflow-hidden rounded-2xl shadow-md md:h-[460px] lg:h-[520px]">
              <Image
                src={image}
                alt={title}
                fill
            ...
            <div className="absolute -bottom-6 left-6 max-w-[260px] rounded-2xl border border-border bg-card p-5 shadow-lg">
              <div className="flex items-center gap-3">
                <span className="w-10 h-10 rounded-xl bg-primary-blue/10 flex items-center justify-center">
                  <Image
                    src={assetSrc(PARTNER_ICONS.headset)}
                    alt=""
                    width={20}
                    height={20}
                    className="w-5 h-5"
